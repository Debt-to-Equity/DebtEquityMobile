...
const Register = (props: IProps) => {
  ...
  const [form, handleFormUpdate] = useForm({ email: '', password: '', confirmPassword: '', token: '', phoneNumber: '' })
  ...
  return (
    <SafeAreaView>
      <View style={{ backgroundColor: Colors.backgroundColor, paddingHorizontal: 20 }}>
        ...
        <HelperText type='error' visible={errorMessage && errorMessage.includes('Email') ? true : false} >{errorMessage}</HelperText>
        <TextInput
          mode="outlined"
        ...
        <HelperText type='error' visible={errorMessage && errorMessage.includes('do not match') ? true : false} >{errorMessage}</HelperText>
        <TextInput
          mode="outlined"
          style={{ marginBottom: 15 }}
        ...
        <HelperText type='error' visible={errorMessage && errorMessage.includes('phone') ? true : false} >{errorMessage}</HelperText>
        <TextInput
          mode="outlined"
          style={{ marginBottom: 15 }}
          label="Phone Number"
        ...
        <HelperText type='error' visible={errorMessage && errorMessage.includes('token') ? true : false} >{errorMessage}</HelperText>
        <TextInput
          mode="outlined"
          label="Token"
